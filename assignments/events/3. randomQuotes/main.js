...
//please scroll below the quotes array
...
var randomNumberLessThanQuotesLength =
  Math.floor(Math.random() * quotes.length) + 1;

console.log(
  `${quotes[randomNumberLessThanQuotesLength].quoteAuthor}, ${quotes[randomNumberLessThanQuotesLength].quoteText} `
);

const h1 = document.querySelector("h1");
h1.textContent = ` ${quotes[randomNumberLessThanQuotesLength].quoteText}`
document.body.append(h1);

const h3 = document.querySelector("h3");
h3.textContent = `- ${quotes[randomNumberLessThanQuotesLength].quoteAuthor}`;
